...
import com.packtpub.libgdx.dangerdungeon.util.CharacterSkin;
import com.packtpub.libgdx.dangerdungeon.screens.AbstractGameScreen;
...
/**
 * Creates the screen that will hold the menu
...
public class MenuScreen extends AbstractGameScreen
{
	...
	{
		skinCanyonBunny = new Skin(Gdx.files.internal(Constants.SKIN_DANGERDUNGEON_UI),
	...
	private Table buildOptWinSkinSelection()
	{
		...
		// + Skin preview image
		imgCharSkin = new Image(Assets.instance.knight.knightFront);
